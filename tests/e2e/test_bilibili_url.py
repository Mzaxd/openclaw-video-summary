...
class BilibiliUrlE2ETest(unittest.TestCase):
    def test_bilibili_url_fast_mode_template(self) -> None:
        url = os.environ.get("OCVS_BILIBILI_URL")
        api_base = os.environ.get("OCVS_API_BASE")
        api_key = os.environ.get("OCVS_API_KEY")

        self.assertTrue(url, "Set OCVS_BILIBILI_URL to enable the Bilibili E2E template")
        self.assertTrue(api_base, "Set OCVS_API_BASE to enable the Bilibili E2E template")
        self.assertTrue(api_key, "Set OCVS_API_KEY to enable the Bilibili E2E template")
